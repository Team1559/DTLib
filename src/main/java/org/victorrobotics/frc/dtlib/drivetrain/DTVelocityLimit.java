...
public final class DTVelocityLimit {
    public final double maximumLinearVelocity;
    ...
    public DTVelocityLimit(double minTranslation, double maxTranslation, double minRotation,
            double maxRotation) {
        maximumLinearVelocity = Double.isFinite(maxTranslation) ? Math.abs(maxTranslation)
                : Double.NaN;
        ...
        if ((!Double.isNaN(maximumLinearVelocity) && !Double.isNaN(minimumLinearVelocity)
                && minimumLinearVelocity > maximumLinearVelocity)
    ...
    public boolean apply(ChassisSpeeds speeds) {
        ...
        if (!Double.isNaN(maximumLinearVelocity)) {
            ...
            if (translationVelocityMagnitude > maximumLinearVelocity) {
                translationVelocity = translationVelocity.times(
                        maximumLinearVelocity / translationVelocityMagnitude);
