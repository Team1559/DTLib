...
public class DTLogger {
  ...
  private static final byte[] DTLIB_LOGGER_BYTES = { 0x44, 0x54, 0x4c, 0x69, 0x62, 0x20, 0x4c, 0x6f,
      0x67, 0x67, 0x65, 0x72 };
  ...
  private static void openCapture() throws IOException {
    ...
    fileChannel = Files.newByteChannel(filepath, StandardOpenOption.WRITE,
