...
public interface DTMotor extends DTSendable {
  ...
  default void initSendable(SendableBuilder builder) {
    ...
    // builder.addBooleanProperty("Brake mode", limitRate(this::isBrakeEnabled,
    // UPDATE_RATE_SLOW_HZ), this::configBrakeMode);
    builder.addBooleanProperty("Inverted", limitRate(this::isOutputInverted, UPDATE_RATE_SLOW_HZ),
                               this::configOutputInverted);

    // builder.addDoubleProperty("kP", limitRate(this::getPIDproportional,
    // UPDATE_RATE_SLOW_HZ), this::configPIDproportional);
    // builder.addDoubleProperty("kI", limitRate(this::getPIDintegral,
    // UPDATE_RATE_SLOW_HZ), this::configPIDintegral);
    // builder.addDoubleProperty("kD", limitRate(this::getPIDderivative,
    // UPDATE_RATE_SLOW_HZ), this::configPIDderivative);
    // builder.addDoubleProperty("kF", limitRate(this::getPIDfeedforward,
    // UPDATE_RATE_SLOW_HZ), this::configPIDfeedforward);
    // builder.addDoubleProperty("kIZ", limitRate(this::getPIDintegralZone,
    // UPDATE_RATE_SLOW_HZ), this::configPIDintegralZone);
    ...
    builder.addBooleanProperty("Fault",
                               limitRate(() -> getFaults().hasAnyFault(), UPDATE_RATE_STD_HZ),
                               null);
